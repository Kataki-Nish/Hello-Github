...
class C:
    ...
    def get_self_list(self):
        return [self.fname,self.lname,self.phone,self.cdml,self.ID]
def main():
    while True:
        try:
                            ...
                            if op_s=="Back":
                                ...
                                while True:
                                    ...
                                    if wch=="back":
                                        ...
                                        first_name1=found.fname
                                        found.fname=ch_g()
                                        while True:
                                            print("Options: Accept | Back")
                                            fname_a=input("Option= ").lower().strip()
                                            if fname_a=="back":
                                                print(f"Don't Saved: {found.fname}")
                                                found.fname=first_name1
                                                break
                                            elif fname_a=="accept":
                                                print(f"Saved: {found.fname}")
                                                break
                                            else:
                                                print(Error_003)
                                                continue
